...
BEGIN
    ...
    (gender_group_id, 'Nonbinary', 'Nonbinary figures present in the artwork'),
    (gender_group_id, 'Androgynous', 'Androgynous or gender-ambiguous figures present in the artwork'),
